...
public sealed class UpdateCultureAntibioticCommandValidator : AbstractValidator<UpdateCultureAntibioticCommand>
{
    public UpdateCultureAntibioticCommandValidator()
    {
